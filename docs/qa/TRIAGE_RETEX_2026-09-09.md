...
> `docs/PROTOCOLES/04_CAPITALISATION_RETEX.md`, RET-1/RET-3).
...
|---|---|---|
| #7089 | RETEX : dette i18n — consolider les gardes bloquantes (clés manquantes) | L-10 |
| #7090 | RETEX : saturation CI — mesurer et durcir quotas/fast-path | L-12 |
| #7091 | RETEX : mojibake — étendre les gardes d'encodage aux fichiers dupliqués entre apps | L-09/L-07 |
| #7092 | RETEX : contournement de gardes — tracer tout contournement en issue immédiate | L-14 |
...
3. Prochain tri : revue mensuelle (RET-6) — les ~70 fichiers sont re-scannés par mots-
