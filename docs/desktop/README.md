...
> Créé le 2026-09-09 (issue #7072). Cadre normatif : `docs/PROTOCOLES/06_DESKTOP_TRANCHES_VERTICALES.md`
> (règles DSK-*). Ce dossier est le **registre vivant** des clients desktop
...
Chaque activation suit DSK-2 (issue de décision `process` + `desktop` + BC) puis la
...
4. **Canaux** : dev (GitHub Release `desktop-<app>-dev`, non signé toléré, marqué) →
   ...
   tranche).
5. **DoD de tranche** : checklist DSK-8 du protocole 06 (build CI vert ×OS, tests
...
- Protocole desktop : `docs/PROTOCOLES/06_DESKTOP_TRANCHES_VERTICALES.md`
