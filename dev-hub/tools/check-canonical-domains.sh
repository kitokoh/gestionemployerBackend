...
REGISTRY=(
  ...
  $'leopardo-prod.onrender.com\tlive'
  $'leopardo-prod.vercel.app\tlive'
  $'leo-admin-prod.pages.dev\tlive'
  # Surfaces verticales Vercel v1 (issue #6918) - dev + prod
  $'leopardo-resto.vercel.app\tlive'
  $'leopardo-travel.vercel.app\tlive'
  $'leopardo-fuel.vercel.app\tlive'
  $'leopardo-edu.vercel.app\tlive'
  $'leopardo-delivery.vercel.app\tlive'
  $'leopardo-resto-prod.vercel.app\tlive'
  $'leopardo-travel-prod.vercel.app\tlive'
  $'leopardo-fuel-prod.vercel.app\tlive'
  $'leopardo-edu-prod.vercel.app\tlive'
  $'leopardo-delivery-prod.vercel.app\tlive'
