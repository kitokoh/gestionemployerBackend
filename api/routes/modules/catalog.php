...
use App\Modules\Catalog\Interfaces\Api\V1\Controllers\CatalogInquiryController;
...
Route::middleware(['throttle:api', 'auth:sanctum', 'token.refresh', 'tenant', 'throttle:api-plan', 'module.catalog'])
    ...
    ->group(function (): void {
        ...
        // Demandes de devis B2B — back-office tenant (C-BACKOFFICE #6885),
        // réservé principal/rh/manager (contrôle dans le contrôleur).
