 ...
 * vitrine : `GET /public/vitrine/{slug}?token=...` sert alors le brouillon au
 * demandeur, avec `X-Robots-Tag: noindex` (jamais indexé, jamais mis en
 * cache). Régénérer invalide l'ancien jeton ; publier le révoque. Le jeton
 * n'est JAMAIS exposé par l'API publique — seul `GET /showcase` (gestion)
 * le rend au responsable.
 */
