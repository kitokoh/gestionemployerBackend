...
class CompanyProvisioningService
{
    ...
    {
        $result = $this->tenantContext->withPublic(function () use ($payload): array {
            ...
            return DB::transaction(function () use ($payload, $trialDays, $slug): array {
                ...
                $manager = $this->tenantContext->withCompany($company, function () use ($payload, $company): Employee {
