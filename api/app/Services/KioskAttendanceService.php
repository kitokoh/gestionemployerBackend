...
class KioskAttendanceService
{
    ...
    {
        return $this->tenantContext->withCompany($kiosk->company, function () use ($kiosk, $identifier, $action): AttendanceLog {
    ...
    {
        return $this->tenantContext->withCompany($kiosk->company, function () use ($kiosk, $events): array {
            $processed = [];
